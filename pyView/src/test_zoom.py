...
def test_zoom_left_double_set_apply():
    mockDisp = Mockup(0, 0, 100, 100)
    mockImg = Mockup(0, 0, 100, 100)
    zoomDisp = ZoomScope(100, 100)
...
def test_zoom_center_set_apply():
    mockDisp = Mockup(0, 0, 100, 100)
    mockImg = Mockup(0, 0, 100, 100)
    zoomDisp = ZoomScope(100, 100)

    zoomDisp.set(25, 75, 25, 75, mockDisp)
...
def test_zoom_double_center_set_apply():
    mockDisp = Mockup(0, 0, 100, 100)
    mockImg = Mockup(0, 0, 100, 100)
    zoomDisp = ZoomScope(100, 100)
...
def test_zoom_right_set_apply():
    mockDisp = Mockup(0, 0, 100, 100)
    mockImg = Mockup(0, 0, 100, 100)
    zoomDisp = ZoomScope(100, 100)

    zoomDisp.set(50, 100, 50, 100, mockDisp)
...
def test_zoom_right_double_set_apply():
    mockDisp = Mockup(0, 0, 100, 100)
    mockImg = Mockup(0, 0, 100, 100)
    zoomDisp = ZoomScope(100, 100)
...
def test_zoom_diff_image_display_apply():
    mockDisp = Mockup(0, 0, 100, 100)
